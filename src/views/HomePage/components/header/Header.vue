    ...
    <div id="Header">
        <div class="headerContent">
            ...
            <div class="left">
                    ...
                    <span class="address">{{ city || "黄冈市" }}</span>
                    <svg viewBox="0 0 32 32" class="icon subscript">
                        <path fill="#81838E" fill-rule="evenodd"
            ...
            <!-- 右边搜索部分 -->
            <div class="right" @click="tosearchShop">
                    <div class="content">
...
<script>
    ...
    export default {
        ...
        methods: {
            getLocationInfo(){
                let geolocation = new qq.maps.Geolocation("F5WBZ-ASHCF-4QAJM-NG6HW-BKILZ-UUFPG", "shop-map");
                geolocation.getLocation(this.showLocation, this.errLocation);
            },
            ...
            tosearchShop(){
                if(this.userInfo.token){
                    this.$router.push("/home/searchShop");
                }else {
...
<style scoped lang="less">
    ...
    #Header>.headerContent>.left>.icon{
        margin-right: 5px;
    }
    #Header>.headerContent>.left>.subscript{
        margin-left: 40px;

    }
    #Header>.headerContent>.left svg{
        width: 20px;
    }
    ...
    #Header>.headerContent>.right>.content{
        display: flex;
        align-items: center;


    }
    #Header>.headerContent>.right>.content svg{
        width: 20px;
        margin-top: 1px;
        margin-right: 3px;
    }
